...
MainWindow::MainWindow()
  : _settings("Bilaicoin", BTS_BLOCKCHAIN_NAME),
  ...
  if(ok) {
    ...
    try {
      ...
      QMessageBox::critical(this,
                            ...
                            tr("Failed to restore wallet backup. Your original wallet has been restored. Error: %1If you are sure that your password and backup file are correct, please post a support request here: https://bilaicointalk.org/index.php/board,45.0.html").arg(e.to_string().c_str()));
    }
  } else return;
